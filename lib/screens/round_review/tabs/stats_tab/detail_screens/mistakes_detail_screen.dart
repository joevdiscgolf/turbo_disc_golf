...
import 'package:turbo_disc_golf/screens/round_review/tabs/round_stats_tab/detail_screens/mistakes_detail/components/potential_score_card.dart';
  ...
  Widget build(BuildContext context) {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      locator.get<LoggingService>().track(
        'Screen Impression',
        properties: {
          'screen_name': MistakesDetailScreen.screenName,
          'screen_class': 'MistakesDetailScreen',
        },
      );
    });
