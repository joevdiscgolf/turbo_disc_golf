...
class RoundStatsBody extends StatefulWidget {
  ...
  @override
  State<RoundStatsBody> createState() => _RoundStatsBodyState();
}

class _RoundStatsBodyState extends State<RoundStatsBody>
  ...
  void _pushDetailScreen(int tabIndex) {
    ...
    switch (tabIndex) {
      case 1: // Skills
        detailScreen = SkillsDetailScreen(round: widget.round);
        title = 'Skills';
        break;
      case 4: // Drives
        detailScreen = DrivesDetailScreen(round: widget.round);
        title = 'Driving';
        break;
      case 5: // Putting
        detailScreen = PuttingDetailScreen(round: widget.round);
        title = 'Putting';
        break;
      case 6: // Discs
