...
class DiscsDetailScreen extends StatelessWidget {
  ...
  Widget _buildTopPerformingDiscsSection(
    ...
    return Column(
      ...
      children: addRunSpacing(widgets, runSpacing: 8, axis: Axis.vertical),
    );
  }
...
class _TopPerformerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final heroChild = Theme(
      ...
      child: Container(
        ...
        child: ExpansionTile(
          ...
          children: [_buildExpansionContent(context, throws)],
        ),
      ),
    );
    ...
    return locator.get<FeatureFlagService>().useHeroAnimationsForRoundReview
        ? Card(
            ...
            child: Hero(
              tag: 'top_disc_$rank',
              child: Material(color: Colors.transparent, child: heroChild),
            ),
          )
        : Card(
            margin: EdgeInsets.zero,
  ...
  Widget _buildExpansionContent(BuildContext context, List<dynamic> throws) {
    return Padding(
              ...
              Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Center(
                      child: Text(
                        '${c1InRegPct.toStringAsFixed(0)}% C1 reg',
                        style: Theme.of(context).textTheme.bodySmall?.copyWith(
                          fontWeight: FontWeight.bold,
