...
class PuttHeatMapCard extends StatefulWidget {
  const PuttHeatMapCard({
    super.key,
    required this.round,
  ...
  @override
  State<PuttHeatMapCard> createState() => _PuttHeatMapCardState();
}

class _PuttHeatMapCardState extends State<PuttHeatMapCard>
...
class _HeatMapPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final closestSegmentPaint = Paint()
      ..color =
          PuttHeatMapCard.segmentColors[0] // Medium-light green
      ..style = PaintingStyle.fill;

    final middleSegmentPaint = Paint()
      ..color =
          PuttHeatMapCard.segmentColors[1] // Very light green
      ..style = PaintingStyle.fill;

    final farthestSegmentPaint = Paint()
      ..color =
          PuttHeatMapCard.segmentColors[2] // White
      ..style = PaintingStyle.fill;
