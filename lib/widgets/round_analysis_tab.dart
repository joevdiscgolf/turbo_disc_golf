...
class RoundAnalysisTab extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final topDiscs = statsService.getTopPerformingDiscs(limit: 5);
    final approachComparison = statsService.compareBackhandVsForehandApproaches();
    final teeStats = statsService.getTechniqueStats(ThrowPurpose.teeDrive);
              ...
              ...approachStats.entries.map((entry) {
                ...
                return Padding(
                  ...
                  child: StatRow(
                    ...
                    value:
                        '${stats.successful}/${stats.attempts} successful',
