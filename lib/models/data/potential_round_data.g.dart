...
PotentialDiscThrow _$PotentialDiscThrowFromJson(Map json) => PotentialDiscThrow(
...
Map<String, dynamic> _$PotentialDiscThrowToJson(PotentialDiscThrow instance) =>
    <String, dynamic>{
...
PotentialDGHole _$PotentialDGHoleFromJson(Map json) => PotentialDGHole(
  ...
  throws: (json['throws'] as List<dynamic>?)
      ?.map(
        (e) => PotentialDiscThrow.fromJson(Map<String, dynamic>.from(e as Map)),
      )
      .toList(),
