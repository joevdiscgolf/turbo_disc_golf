...
part 'user_alignment_metadata.g.dart';

/// Pro overlay alignment data for rendering pro reference over user pose
@JsonSerializable()
class UserAlignmentMetadata {
  const UserAlignmentMetadata({
  ...
  factory UserAlignmentMetadata.fromJson(Map<String, dynamic> json) =>
      _$UserAlignmentMetadataFromJson(json);
  Map<String, dynamic> toJson() => _$UserAlignmentMetadataToJson(this);
}
