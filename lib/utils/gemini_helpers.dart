...
abstract class GeminiHelpers {
  /// Builds the appropriate parsing prompt based on whether pre-parsed holes exist
  static String buildGeminiParsingPrompt(
...
''';
  ...
  static String _buildVoiceOnlyPrompt(
    String voiceTranscript,
    List<DGDisc> userBag,
    String? courseName,
  ) {
